export type SceneBadge = 'NEW' | 'HOT' | null;
...
export const SCENES: Scene[] = [
  ...
  },
  {
    ...
    prompt:
      'Use the uploaded reference image(s) for the male or female subject. The facial identity must be reproduced 1:1 with no changes to bone structure, facial proportions, skin tone, hairline, or expression. No beautification. No substitutions. No face smoothing. Place the subject standing next to a matte black Mercedes-AMG GT 63S with a deep purple leather interior visible through the open door, parked on a reflective wet street in Downtown Dubai at night. The Burj Khalifa rises dramatically in the background, fully lit, with warm city lights reflecting off the car and the pavement. Cinematic night photography, dramatic rim lighting from the skyline, shallow depth of field. Shot on iPhone 15 Pro Max. RAW capture. Photorealistic. No AI aesthetic. No CGI. No watermark. No text. 8K quality.',
  },
  {
    id: 'private-jet',
    emoji: '🛩️',
    ...
    prompt:
      'Use the uploaded reference image(s) for the male or female subject. The facial identity must be reproduced 1:1 with no changes to bone structure, facial proportions, skin tone, hairline, or expression. No beautification. No substitutions. No face smoothing. Place the subject walking toward a Gulfstream G700 private jet on a private airport tarmac at night, jet stairs deployed with warm cabin light glowing from inside. The subject carries a Louis Vuitton Keepall duffel bag, wears a Rolex Daytona watch, and an Essentials hoodie with matching sweatpants. Ambient tarmac floodlights, cinematic low-key lighting, sense of quiet luxury and travel. Shot on iPhone 15 Pro Max. RAW capture. Photorealistic. No AI aesthetic. No CGI. No watermark. No text. 8K quality.',
  },
  {
    id: 'monaco-rooftop',
    emoji: '🇲🇨',
    ...
    prompt:
      'Use the uploaded reference image(s) for the male or female subject. The facial identity must be reproduced 1:1 with no changes to bone structure, facial proportions, skin tone, hairline, or expression. No beautification. No substitutions. No face smoothing. Place the subject on a luxury rooftop terrace bar in Monte Carlo, Monaco, at dusk, overlooking a marina filled with superyachts and the illuminated Monte Carlo Casino in the distance. The subject wears an open linen resort shirt and a Patek Philippe Nautilus watch. Golden hour lighting mixed with warm terrace ambient lights, soft bokeh from string lights, opulent Mediterranean atmosphere. Shot on iPhone 15 Pro Max. RAW capture. Photorealistic. No AI aesthetic. No CGI. No watermark. No text. 8K quality.',
  },
  {
  ...
  },
  {
    ...
    prompt:
      'Use the uploaded reference image(s) for the male or female subject. The facial identity must be reproduced 1:1 with no changes to bone structure, facial proportions, skin tone, hairline, or expression. No beautification. No substitutions. No face smoothing. Place the subject standing on a rooftop helipad next to a parked Airbus H145 helicopter, with the Hong Kong skyline and Victoria Harbour visible in the background at dusk, skyscraper lights beginning to glow. The subject wears a Moncler puffer jacket and an Audemars Piguet Royal Oak Offshore watch. Wind-swept hair, dramatic elevated perspective, crisp cool-toned lighting. Shot on iPhone 15 Pro Max. RAW capture. Photorealistic. No AI aesthetic. No CGI. No watermark. No text. 8K quality.',
  },
  {
    id: 'paris-night',
    emoji: '🗼',
  ...
  },
  {
    ...
    prompt:
      'Use the uploaded reference image(s) for the male or female subject. The facial identity must be reproduced 1:1 with no changes to bone structure, facial proportions, skin tone, hairline, or expression. No beautification. No substitutions. No face smoothing. Place the subject leaning against a white Ferrari Roma Spider parked on a cliffside road above Positano on the Amalfi Coast during blue hour, the pastel cliffside village and Tyrrhenian Sea visible below. The subject wears a cream Loro Piana jacket. Soft blue-hour light mixed with warm village lights below, Mediterranean coastal ambience, cinematic wide shot. Shot on iPhone 15 Pro Max. RAW capture. Photorealistic. No AI aesthetic. No CGI. No watermark. No text. 8K quality.',
  },
  {
    id: 'burj-old-money',
    emoji: '🏙️',
    ...
    prompt:
      'Use the uploaded reference image(s) for the male or female subject. The facial identity must be reproduced 1:1 with no changes to bone structure, facial proportions, skin tone, hairline, or expression. No beautification. No substitutions. No face smoothing. Place the subject standing beside a Ferrari Roma Spider on an open plaza in Downtown Dubai at night, the fully illuminated Burj Khalifa rising directly behind. The subject wears a tailored Brunello Cucinelli blazer and a Patek Philippe Calatrava watch. Old-money elegance, warm architectural up-lighting, cinematic symmetrical composition. Shot on iPhone 15 Pro Max. RAW capture. Photorealistic. No AI aesthetic. No CGI. No watermark. No text. 8K quality.',
  },
];

export const FILTER_CATEGORIES = ['All', 'Luxury', 'Dubai', 'Europe', 'Jets', 'Lifestyle'] as const;
